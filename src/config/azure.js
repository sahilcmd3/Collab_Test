...
const database = cosmosClient.database(process.env.NEXT_PUBLIC_AZURE_COSMOS_DB_DATABASE_NAME);
const container = database.container(process.env.NEXT_PUBLIC_AZURE_COSMOS_DB_CONTAINER_NAME);
